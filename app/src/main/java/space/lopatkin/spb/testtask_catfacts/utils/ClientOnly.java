...
public class ClientOnly {
    ...
    public List<Fact> clientItems() {
        ...
        try {
            String url = Uri.parse("https://cat-fact.herokuapp.com/facts")
                    .buildUpon()
                    //параметры запроса
...
//            Toast.makeText(ActivityMain.getApplication(), "ошибка загрузки данных", Toast.LENGTH_SHORT).show();
            ...
            Log.d(TAG, "ошибка парсинга JSON", jsone);
        }
        return list;
    }
